...
<?php
include('../koneksi.php');
$queryangkutan = mysqli_query ($konek, "SELECT * FROM angkutan ORDER BY tgl DESC");
while($row = mysqli_fetch_array($queryangkutan))
{
  ...
  echo '<tr>
    ...
    <td colspan="2">: '.$row['noken'].' </td>
  </tr>';
  echo '<tr>
    <td>&nbsp;</td>
    <td>Nama</td>
    <td colspan="2">: '.$row['supir'].' </td>
  </tr>';
  echo '<tr>
    <td colspan="4"><div align="justify">
      <p>&nbsp;</p>
